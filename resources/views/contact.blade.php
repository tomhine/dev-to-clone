<x-app-layout>
    <article class="w-full max-w-5xl mx-auto bg-white rounded-md border px-16 py-8 space-y-8 text-xl mb-36">
        <section class="space-y-6">
            ...
            <p>Report a vulnerability: <x-link.a href="#" class="underline">dev.to/security</x-link.a> 🐛
            </p>
            <p>To report a bug, please create <x-link.a href="#" class="underline">a bug report</x-link.a> in our open
                source repository.</p>
